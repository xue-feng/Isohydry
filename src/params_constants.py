...
P_baro = 90.00      # kPa, atmospheric pressure at 1000 m 

nu = 10**6      # unit conversion Pa/MPa  
rhoH2O = 1000   # density of water, kg/m3
...
CO2conc = 0.000400 # in ppm

xylem_scalefactor = 500     # scaling xylem conductivity from the tissue to the whole plant level 