...
# ''' generate samples '''
# t0=time.time()
# Y_pine, param_pine = generate_samples('JUNI',n_runs=100, VPD=VPD,tmax=tmax)
...
ax = fig.add_subplot(141); plot_ind(beta, 'P50/Pg12') 
ax = fig.add_subplot(142); plot_ind(delta, 'Psat_soil/P50')
ax = fig.add_subplot(143); plot_ind(kappa, 'gmax_stem/gmax_root')
ax = fig.add_subplot(144); plot_ind(f, '(gmax_stem*P50)/gmax_canopy*VPD')
plt.tight_layout()
plt.show()
